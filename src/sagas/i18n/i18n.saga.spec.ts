...
import { CallEffect, PutEffect, SelectEffect } from 'redux-saga';
...
describe('sagas/i18n', () => {
  describe('set browser language to reducer', () => {
    ...
    it('should dispatch REQUESTED action', (result: SelectEffect<*, *>): * => {
      const effect: SelectEffect<*, *> = select(
        (state: Object): string => state.i18n,
      );
    ...
    it('set browser lang if value is null', (result: CallEffect<
      *,
      *,
      *,
    >): Either => {
